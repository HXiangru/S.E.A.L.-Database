-- FUNCTION: public.insert_data_reference(integer, text, integer)

-- DROP FUNCTION IF EXISTS public.insert_data_reference(integer, text, integer);
...
ALTER FUNCTION public.insert_data_reference(integer, text, integer)
    OWNER TO postgres;
